...
<head>
	...
	<title>CONFIRMAÇÃO DE CONTATO [MANUAL PROCESS] | AGREGA FILMES &copy;</title>
		...
		?>
			<form action="confirm.php" method="post">
				<div class="form-group">
					...
					<button type="submit" class="btn btn-info btn-block">Enviar confirmação <i class="fas fa-share-square"></i></button>
			...
			<div class="card-footer bg-white mx-auto mx-md-0"><span class="badge badge-dark float-left float-md-left m-2 m-md-auto"><span class="badge badge-warning">MANUAL PROCESS</span> <i class="fas fa-save"></i></span><small class="text-dark float-left float-md-right m-2 m-md-auto"> by Evotech Solutions | 2018.</small></div>
		</div>
	</div>
